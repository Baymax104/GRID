...
The output file `merged_predictions_tensor.pt` is a model output bundle with the form
...
python -m src.main experiment=rkmeans_train \
    ...
    embedding_path=<output_path_from_step_2>/merged_predictions_tensor.pt \ # model output bundle from step 2
...
python -m src.main experiment=tiger_train \
    data_dir=data/amazon_data/beauty \ 
    semantic_id_path=<output_path_from_step_3>/pickle/merged_predictions_tensor.pt \ # model output bundle from step 3
